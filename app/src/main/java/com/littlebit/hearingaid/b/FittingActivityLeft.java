...
public class FittingActivityLeft extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fitting_left);
        ...
        startPartialFittingButton.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(FittingActivityLeft.this)
    ...
    private void playTone(int freqHz, float volume) {
        ...
        for (final double dVal : sample) {
            short left = (short) ((dVal * 32767.0) * volume);
            short right  = 0;
